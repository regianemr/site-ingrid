      ...
      <div className="grid max-w-screen px-8 mx-auto lg:gap-6 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="m-8 place-self-center lg:col-span-7">
          ...
          <div className="flex flex-wrap gap-2">
            <Button size="xl" className="bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:bg-gradient-to-l focus:ring-purple-200 dark:focus:ring-purple-800">
              <a href="#" className="inline-flex items-center justify-center px-8 py-3 mr-3 text-base font-medium text-center text-white rounded-lg">
                QUERO ADQUIRIR MEU CURSO
              </a>
            </Button>
          </div>
        </div>
